...
--
-- Hôte : 127.0.0.1:3308
-- Généré le : lun. 08 mars 2021 à 16:13
...
--
-- Déchargement des données de la table `thenews_has_thesection`
--

INSERT INTO `thenews_has_thesection` (`theNews_idtheNews`, `theSection_idtheSection`)
VALUES (1, 1),
       (1, 3),
       (1, 4);
